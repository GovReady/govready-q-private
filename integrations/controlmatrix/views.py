...
from .communicate import ControlmatrixCommunication

# Change 'example' to name of integration, e.g., 'csam' and 'csam_system_id'
INTEGRATION_NAME = 'controlmatrix'
INTEGRATION_SYSTEM_ID = 'controlmatrix_system_id'
...
def set_integration():
    return ControlmatrixCommunication()
